...
export default function Home() {
  ...
  const filteredSections = sections.sections.filter(section => section.id !== "#0");
    ...
    <>
      ...
      <Location />
        <main className="content-padding max-w-4xl md:max-w-7xl w-full mx-auto">
          ...
          <Box className="flex justify-between items-center pb-4 px-2 font-mono" fontSize="sm" color="earth.300">
