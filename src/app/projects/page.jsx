      ...
      <main className="content-padding max-w-7xl w-full mx-auto"> 
        <Box className="section-intro center max-w-2xl mx-auto">
          ...
          <Text className="text-earth-200 mt-8 text-center" fontSize="lg">
            A selection of UX/UI and frontend projects—from playful experiments to real-world solutions—highlighting my approach to digital design, user insight, and thoughtful development
          </Text>
        </Box>
        <Box
          maxW="6xl"
