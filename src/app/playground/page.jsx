      ...
      <main className="content-padding max-w-5xl w-full mx-auto">
        <Box className="section-intro center max-w-2xl mx-auto">
          ...
          <Text className="text-earth-200 mt-8 text-center" fontSize="lg">
            Here you'll find code experiments, playful interfaces, and the
            occasional rogue feature that broke something before it fixed
            something else.
          </Text>
        </Box>
        <Box
          className="max-w-2xl mx-auto py-40"
