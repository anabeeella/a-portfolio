    ...
    >
      ...
      <VStack spacing={4} flex={1} align="stretch" px={4}>
        ...
        <HStack
          ...
          justifyContent="space-evenly"
        >
          <Text fontFamily="mono" fontSize="xs" textTransform="uppercase">
            Name
          </Text>
          <Text fontFamily="mono" fontSize="xs" textTransform="uppercase">
            Role
        ...
        <HStack spacing={4} align="center" py={2}>
          ...
          >
            is authorized to edit the design, code and content of the
            A-portfolio during non-laboral hours upon presentation of this card
          </Text>
        </HStack>
      </VStack>
    </Flex>
