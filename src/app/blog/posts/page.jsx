...
import { Box, Heading, Text, Flex, SimpleGrid, Link, useColorModeValue } from '@chakra-ui/react';
      ...
      <main className="max-w-5xl w-full mx-auto px-4">
        <Box color={textColor} py={8}>
          ...
          <Text color={textColor} className="text-md max-w-xl" mb={8}>
            Latest articles and insights about design, development, and technology.
            <br />Here you'll find in-depth analysis, tutorials, and thoughts from the field.
          </Text>
        </Box>
        ...
        <SimpleGrid columns={{ base: 1, md: 2, lg: 3 }} spacing={8}>
          {posts.map((post) => (
            ...
            >
              ...
              >
                <Text fontSize="xs" fontFamily="mono" color={mutedTextColor} mb={2}>
