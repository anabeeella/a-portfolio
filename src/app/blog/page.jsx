        ...
        <main className="content-padding max-w-5xl w-full mx-auto">
          <Box color={textColor} className="section-intro">
            ...
            <Text color={textColor} className="text-lg" mb={8}>
              A collection of thoughts, resources, and inspiration from the
              field. Here you'll find articles about design, development, and
              technology, along with curated resources and inspiring works.
            </Text>
            ...
            >
              {sections.sections
                .find(section => section.link === '/blog')
