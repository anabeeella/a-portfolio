...
import { Box, Heading, Text, Flex, Grid, useColorModeValue } from '@chakra-ui/react';
        ...
        <main className="content-padding max-w-5xl w-full">
          <Box color={textColor} className="section-intro">
            ...
            <Text color={textColor} className="text-md" mb={8}>
              Curated tools, libraries, and materials for designers and developers.
              A collection of useful resources to help you in your creative journey.
            </Text>
          </Box>
